...
class AppBottomBarButton extends StatefulWidget {
  final bool? active;
  final bool? debug;
  final bool? haptic;
  final double? gap;
  ...
  @override
  AppBottomBarButtonState createState() => AppBottomBarButtonState();
}

class AppBottomBarButtonState extends State<AppBottomBarButton> {
  @override
